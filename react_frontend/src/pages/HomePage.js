                                ...
                                <SignInSection>
                                    {
                                        <div className="dark-box">
                                            ...
                                            <div className="lower">
                                                ...
                                                fluent in English and to excel
                                                in their studies
                                            </div>
                                ...
                                <div className="row">
                                    <div className="col-12 col-sm-4">
                                        ...
                                        <div className="subCaption">
                                            Create an account to begin studying
                                    ...
                                    <div className="col-12 col-sm-4">
                                        ...
                                        <br />
                                        <div className="subCaption">
                                            Lessons are designed specifically
                                            for Cambodian exam preparation
                                        </div>
                                    </div>
                                    <div className="col-12 col-sm-4">
                                        <AcheiveIcon />
                                        ...
                                        <br />
                                        <div className="subCaption">
                                            Connect with your personal tutor to
                                ...
                                >
                                    <div className="no-gutter">
                                        <RightBox>
                                            <br />
                                            <br />
                                            <BoxText>Flexible Learning</BoxText>
                                            <br />
                                            <BoxText> ________</BoxText>
                                            <br />
                                            <br />
                                            <BoxSubText>
                                                Access your lessons, worksheets,
                                                and quizzes anywhere and anytime
                            ...
                            <div className="row">
                                ...
                                >
                                    <LeftBox>
                                        ...
                                        <br />
                                        <BoxRightSubText>
                                            Tutors provide rapid, individual
                                            feedback on your work and can answer
                                            questions or help with editing
                                        </BoxRightSubText>
                                    </LeftBox>
                                </div>
                                <div
