        ...
        return(
            <div>
                <LessonBox>
                    ...
                    <LessonProps> Quiz: {this.props.quizName} Grade: {this.props.quizPercentage} <Button onClick={this.gotoQuiz} bsStyle="primary">{quiz}</Button> <Button onClick={this.gotoPastQuiz} bsStyle="primary"> Review </Button></LessonProps>
                </LessonBox>
            </div>
        );
    }
