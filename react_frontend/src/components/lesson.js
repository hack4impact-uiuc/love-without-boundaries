        ...
        return (
            <div className="row" style={{ margin: '0 auto' }}>
                <div className="col-sm-6 lesson-box">
                    ...
                    <div className="lesson-btn-box">
                        <div className="row">
                            <a href={this.props.lessonNotesLink}>
                                <SlightlyPaddedButton className="btn lesson-btn">
                                    Notes
                    ...
                    <p className="lesson-quiz-text">
                        {' '}
                        Quiz -- Grade:{' '}
                        {this.props.quizPercentage !== undefined
                            ? `${this.props.quizPercentage}%`
                            : "Haven't taken"}
                    </p>
                    <p style={{ color: 'red' }}>
                        {' '}
                        {this.props.lessonWorksheetLink === undefined ||
                        this.props.lessonWorksheetLink === null
                            ? 'Worksheet Copy doesnt have link'
                            : ''}{' '}
                    </p>
                </div>
            </div>
