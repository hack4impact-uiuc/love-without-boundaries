        ...
        return(
            <div>
                <LessonBox>
                    ...
                    <Link key={this.props.key} style={{ display:'block' }}to={{ pathname: '/takequiz', state:{ lessonID: this.props.id } }}>
                       <Button onClick={this.gotoPastQuiz} bsStyle="primary"> LLOL </Button>
                    </Link>
                </LessonBox>
            </div>
        );
